    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (userID.equals(currentUser)) {
                errorMessage = "Can not delete this user account while using it";
                request.setAttribute("DELETEERROR", errorMessage);
                ...
                boolean isExist = userDAO.checkAccountStatus(userID);
                if (isExist) {
                    boolean rs = userDAO.deleteAccount(userID);
