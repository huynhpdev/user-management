    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (isActive) {
                ...
                boolean isExistedPromotion = promotionDAO.checkExistedPromotionByUserID(txtUserID);
                if (!isExistedPromotion) {
                    promotionDAO = new Tbl_Promotion_DAO();
                    boolean rs = promotionDAO.addPromotion(txtUserID);
                    if (rs) {
                        promotionDAO = new Tbl_Promotion_DAO();
                    ...
                    msg = "Account " + txtUserID + " is existed in promotion list already";
                ...
                msg = "Account " + txtUserID + " does not exist";
                request.setAttribute("MESSAGE", msg);
            }
