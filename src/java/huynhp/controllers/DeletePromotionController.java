...
public class DeletePromotionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String txtPromotionID = request.getParameter("txtPromotionID");
        ...
        try {
            ...
            if (isActive) {
                ...
                if (isExistedPromotion) {
                    promotionDAO = new Tbl_Promotion_DAO();
                    boolean rs = promotionDAO.deletePromotion(Integer.parseInt(txtPromotionID));
                    if (rs) {
                    ...
                    request.setAttribute("DELETEDMESSAGE", msg);
                }
